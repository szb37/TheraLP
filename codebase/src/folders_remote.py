...
models = os.path.abspath('/wynton/protected/home/wooley/szb/TheraLP/models')
data = os.path.abspath('/wynton/protected/home/wooley/szb/TheraLP/data/')
shared = os.path.abspath('/wynton/protected/home/wooley/shared/')
